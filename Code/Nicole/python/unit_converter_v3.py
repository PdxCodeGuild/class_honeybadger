...
def yards_to_meters(yd):
    conversion_factor = 0.9144
    meters = yd * converstion_factor
    return meters

def inches_to_meters(inch):
    converstion_factor = 0.0254
    meters = inch * converstion_factor
    return meters
...
if separated_input[1] == "ft" or separated_input[1] == "feet":
    ...
    print(f"\n{user_input} is {converted_value} meters")
elif separated_input[1] == "yds" or separated_input[1] == "yards" or separated_input[1] == "yard" or separated_input[1] == "yd":
    converted_value = yards_to_meters(separated_input[0])
    print(f"\n{user_input} is {converted_value} meters")
elif separated_input[1] == "in" or separated_input[1] == "inches" or separated_input[1] == "inch" or separated_input[1] == "ins":
    converted_value = inches_to_meters(separated_input[0])
    print(f"\n{user_input} is {converted_value} meters")
else:
