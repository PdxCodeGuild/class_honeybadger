...
function getAnswers(x) {
    for (let i = 0; i < (quiz.questions[x].answers).length; ++i) {
        ...
        // input.dataset.correct = quiz.questions[x].answers[i].correct
        ...
        input.addEventListener("change", function() {
            ...
            if (input.value == "true") {
                true_or_false.innerText = "That is correct!"
                    ++score_num
            } else {
                true_or_false.innerText = "That is incorrect"
            }
    ...
    // this determines if the answer is true or false DOES NOT WORK YET
