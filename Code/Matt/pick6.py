...
def match_checker (winning_numbers, ticket_numbers):
    matches = 0
...
winning_numbers = [random.randint(1,100) for i in range(6)]
...
#     ticket_numbers =  [random.randint(1,100) for i in range(6)]
#     print(match_checker(winning_numbers, ticket_numbers)
